  ...
  <div class="home-wrapper" v-if="account">
    ...
    >
      <div class="explanations">
        <p><b>Utilisateur: </b>{{ account.username }}</p>
    ...
    >
      <div class="explanations" v-if="enterpriseAccount">
        ...
        <p><b>Nom de l'enterprise: </b>{{ enterpriseAccount.name }}</p>
        <p><b>Proprietaire: </b>{{ this.enterpriseOwnerAccount.username }}</p>
        <p><b>Addresse du proprietaire: </b>{{ enterpriseAccount.owner }}</p>
        <div>
          <b>Membrs: </b>
          <p
          ...
          >
          &mdash; {{ member.account.username }} &nbsp; Addresse:
            {{ member.address }}
          </p>
        </div>
    ...
    <card
      title="Projets"
      :subtitle="`Au total: ${projects.length}`"
      v-if="projects"
      :blue="true"
    >
    ...
    <div class="home">
      ...
      >
        <router-link class="card-body" to="/signup-enterprise">
          Cliquer ici pour proceder à sa création
        </router-link>
      </card>
      <card
      ...
      >
        <router-link class="card-body" to="/create-project">
          Cliquer ici pour créer vos projets
        </router-link>
      </card>
      <card
        title="Projets existant"
        :blue="true"
      >
